...
//Here are a few math problems that are very difficult without iteration, but much easier once you add a nice for-in loop.
//Give these problems a shot. Try to make your code as simple as possible. If you are typing 100 lines for one of these problems,
...
//The sum of the squares from 1 to 5 is (1^2 + 2^2 + 3^2 + 4^2 + 5^2) = 55
//The square of the sum from 1 to 5 is (1 + 2 + 3 + 4 + 5)^2 = 225
//The difference between the square of the sum from 1 to 5 and the sum of the squares from 1 to 5 is 225 - 55 = 170
